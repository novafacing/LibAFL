...
pub trait ParseKnown: FromArgMatches {
...
impl LibAFLCCArgs {
    pub fn libafl_no_link(&self) -> bool {
        self.libafl_no_link
    }
    ...
    pub fn libafl_ignore_configurations(&self) -> bool {
        self.libafl_ignore_configurations
    }

    pub fn libafl_configurations(&self) -> &Vec<String> {
        &self.libafl_configurations
    }
}
